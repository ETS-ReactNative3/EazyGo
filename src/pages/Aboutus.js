      ...
      <View
        ...
        <Card style={styles.box}>
          ...
          <Text style={styles.body}>
            Help every business and workers with their transportations and
            hence, acts as a working partner
          </Text>
        </Card>
        <Card style={styles.box}>
          <Text style={styles.heading}>Car Rental</Text>
          <Text style={styles.body}>
            We rent cars/trucks for all requirements of people at affordable
            prices
          </Text>
        </Card>
        <Card style={styles.box}>
          ...
          <Text style={styles.body}>
            We also provide general Taxi Services for your easy mobility within
            city.
          </Text>
        </Card>
      </View>
